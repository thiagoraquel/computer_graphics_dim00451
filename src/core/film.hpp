...
private:
  std::vector<Spectrum> m_color_buffer;  
  std::unordered_map<image_type_e,std::function<bool(const std::vector<unsigned char>&, size_t, size_t, size_t, const std::string&)>> m_image_io_dict;
public:
